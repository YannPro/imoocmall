<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{check: item.checked===1}" @click="checkBox(item)">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration" @click="delCartBefore(item)">
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check" @click="checkAllCart">
                <a href="javascipt:;">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">{{getAllCheckedPrice | currency('$')}}</span>
              </div>
              <div class="btn-wrap">
    ...
    <modal :mdShow="modalFlag">
      <p slot="message">
        <span>你是否删除该商品 </span>
      </p>
      <div slot="btnGroup">
        <a href="javascript:;" @click="delCart()" class="btn btn--m" >确认</a>
        <a href="javascript:;" @click="modalFlag = false" class="btn btn--m">关闭</a>
      </div>
    </modal>
    <vfooter> </vfooter>
  </div>
    ...
    methods: {
      ...
      checkAllCart () {
        ...
        for (let item of this.cartList) {
          this.checkAllFlag === true ? item.checked = 1 : item.checked = 0
        }
        axios.post('users/checkAllCart', {
