<template>
  <div>
    <vheader> </vheader>
    <vbread><span>Address</span></vbread>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in filterAddressList" :class="{'check':index===checkIndex}" @click="addressCheck(item,index)">
                  <dl>
                    <dt>{{item.recipientName}}</dt>
                    <dd class="address">{{item.streetName}}</dd>
                    <dd class="tel">{{item.tel}}</dd>
                  </dl>
                  <div class="addr-opration addr-del" @click="mdShow=true;delAddressId=item.addressId">
                    <a href="javascript:;" class="addr-del-btn">
                      <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                    </a>
                  </div>
                  <div class="addr-opration addr-set-default" v-show="item.isDefault===0" @click="setDefaultAddress(item.addressId)">
            ...
            <div class="shipping-addr-more" @click="showAll">
    ...
    <modal :mdShow="mdShow">
      ...
      <div slot="btnGroup">
        <a href="javascript:;"class="btn btn--m" @click="delAddress(addressId)">确定</a>
