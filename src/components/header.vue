    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container">
        <div class="navbar-menu-container">
          <span class="navbar-link" v-text="'当前账户:'+nickName" v-show="nickName"></span>
          <a href="javascript:void(0)" class="navbar-link" @click="showLogin=true" v-show="!nickName">登录</a>
          <a href="javascript:void(0)" class="navbar-link" v-show="nickName" @click="logout">退出</a>
          <div class="navbar-cart-container" v-show="nickName">
        ...
        <div class="md-modal md-msg md-modal-transition" :class="{'md-show':showLogin}">
              ...
              <div class="confirm-tips">
                ...
                <ul>
                  <li class="regi_form_input">
                    ...
                    <input type="text" tabindex="1" placeholder="用户昵称" name="username" class="regi_login_input" v-model="userName">
                  </li>
                  <li class="regi_form_input npMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password"  tabindex="2" placeholder="用户密码" name="password"class="regi_login_input" v-model="userPwd">
                  </li>
                </ul>
              </div>
    ...
    methods: {
      ...
      getCartCount () {
        axios.get('/users/getCartCount').then((res) => {
          if (res.data.statusCode === 0) {
            console.log(res.data.result.cartCount)
